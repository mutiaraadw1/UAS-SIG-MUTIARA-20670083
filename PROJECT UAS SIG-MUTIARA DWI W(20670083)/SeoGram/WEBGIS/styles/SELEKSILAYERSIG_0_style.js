...
var style_SELEKSILAYERSIG_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Jml.Bidan");
    var labelText = "";
    size = 0;
    ...
    if (value > 18.000000 && value <= 40.400000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 40.400000 && value <= 62.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 62.800000 && value <= 85.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 85.200000 && value <= 107.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 107.600000 && value <= 130.000000) {
            style = [ new ol.style.Style({
