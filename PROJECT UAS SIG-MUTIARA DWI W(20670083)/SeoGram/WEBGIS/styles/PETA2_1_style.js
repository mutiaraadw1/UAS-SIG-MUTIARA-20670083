...
var style_PETA2_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("KD.Puskes");
    var labelText = "";
    size = 0;
    ...
    if (value > 1031851.000000 && value <= 1031854.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1031854.000000 && value <= 1031857.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1031857.000000 && value <= 1031860.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1031860.000000 && value <= 1031863.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1031863.000000 && value <= 1031866.000000) {
            style = [ new ol.style.Style({
